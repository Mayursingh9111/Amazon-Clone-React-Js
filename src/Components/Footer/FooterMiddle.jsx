  ...
  return (
    <section className="bg-[#232F3E] text-white">
      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-center justify-center py-4 md:py-6">
        <a
          href=""
          className="border boder-1 border-gray-400 hover:border-yellow-300 transition-all duration-150 p-2 px-3"
        >
          <img className="w-10 md:w-14 pt-1" src={AmazonImg} alt="" />
        </a>
        <a
          href=""
          className="pb-2 border boder-1 border-gray-400 hover:border-yellow-300 transition-all duration-150 p-1 px-3"
        >
          <span className="text-sm md:text-lg">English</span>
        </a>
        <a
          href=""
          className="border boder-1 flex items-center border-gray-400 hover:border-yellow-300 transition-all duration-150 p-1 px-2"
        >
